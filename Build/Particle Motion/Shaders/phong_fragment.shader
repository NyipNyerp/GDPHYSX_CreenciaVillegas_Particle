...
void main()
{
	...
	float gradient = attenuate(distance, 50.0);
	...
	FragColor = vec4(ambient + (diffuse + specular) * gradient, 1.0) *  texture(texture_diffuse, UV) * 2; // *2 is temporary since light isnt working
